...
public class DelegatingGauge implements Metric, Gauge, Serializable {
  ...
  /**
   * Create a {@code DelegatingGauge} with {@code perWorkerGauge} and {@code
   ...
   */
  public DelegatingGauge(
      MetricName name, boolean processWideContainer, boolean perWorkerGauge) {
    this.name = name;
