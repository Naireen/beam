...
public class MonitoringInfoEncodings {
  ...
  public static ByteString encodeInt64Histogram(HistogramData inputHistogram) {
    ...
    //         Base2Exponent.newBuilder()
    //             .setNumberOfBuckets(numberOfBuckets)
    //             .setScale(buckets.getScale());
    ...
    //   LOG.info(
    //       "xxx inputHistogram.getBucketType().getNumBuckets() {}",
    //       inputHistogram.getBucketType().getNumBuckets());
    //   for (int i = 0; i < inputHistogram.getBucketType().getNumBuckets(); i++) {
    //     LOG.info(
    //         "xxx bucket counts {}, num buckets {}",
    //         i,
    //         inputHistogram.getBucketType().getNumBuckets());
    ...
    //   }
      ...
      // Method[] methods = outputHistogram2.getClass().getMethods();
