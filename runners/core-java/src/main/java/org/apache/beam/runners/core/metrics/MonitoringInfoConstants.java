...
public final class MonitoringInfoConstants {
  ...
  public static final class TypeUrns {
    ...
    public static final String PER_WORKER_HISTOGRAM_TYPE = "beam:metrics:per_worker_histogram_int64:v1";
    ...
    static {
      ...
      checkArgument(PER_WORKER_HISTOGRAM_TYPE.equals(getUrn(MonitoringInfoTypeUrns.Enum.PER_WORKER_HISTOGRAM)));
    }
  }
